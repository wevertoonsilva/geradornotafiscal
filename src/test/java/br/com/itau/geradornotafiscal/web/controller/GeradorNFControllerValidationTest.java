...
class GeradorNFControllerValidationTest {
    ...
    void deveRetornar400QuandoPedidoSemDestinatario() throws Exception {
        Pedido pedido = Pedido.builder()
                ...
                .itens(Collections.singletonList(new Item("1", "Item 1", new BigDecimal("100.00"), 1)))
                .build();
    ...
    void deveRetornar400QuandoPJSemRegimeTributacao() throws Exception {
        Destinatario destinatario = Destinatario.builder()
                ...
                .enderecos(Collections.singletonList(new Endereco()))
                .build();
    ...
    void deveRetornar400QuandoTotaisNaoReconciliam() throws Exception {
        ...
        Pedido pedido = Pedido.builder()
                ...
                .valorFrete(new BigDecimal("10.00"))
                .itens(Collections.singletonList(new Item("1", "Item 1", new BigDecimal("50.00"), 1))) // Total real: 50
                .destinatario(destinatario)
                .build();
